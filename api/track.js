...
<table cellpadding="0" cellspacing="0" border="0" width="600" style="max-width:600px;width:100%;background:#ffffff;border-radius:4px;overflow:hidden;">
  ...
  <tr><td style="background:#ffffff;padding:8px 48px 56px;text-align:center;">
    ...
    <a href="https://booking.ksa.ee/et/icb-time?serviceId=1" style="display:inline-block;background:#87BE23;color:#0F0F0F;font-size:14px;font-weight:700;text-decoration:none;padding:16px 40px;border-radius:3px;letter-spacing:0.02em;">Broneeri uuring &rarr;</a>
...
const EMAIL = {
  ET: {
    ...
    ctaUrl: 'https://booking.ksa.ee/et/icb-service-page',
    ctaAudit: 'Broneeri nägemisuuring Audit',
    ctaAuditUrl: 'https://booking.ksa.ee/et/icb-time?serviceId=6',
  ...
  ET: [
    {
      ...
      build: (code) => buildSeqHtml(
        ...
        `https://booking.ksa.ee/et/icb-service-page?promokood=${code}`,
